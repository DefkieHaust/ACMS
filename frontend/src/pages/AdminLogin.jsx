      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-surface dark:bg-surface-dark">
        <div className="w-full max-w-sm animate-fade-in-up">
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-display text-gray-900 dark:text-white">Admin access</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Sign in to the admin portal</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 text-center">
            <Link to="/login" className="text-sm text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
              Resident or Committee? <span className="font-medium text-primary-600 dark:text-primary-400">Sign in here</span>
            </Link>
          </div>
        </div>
      </div>
